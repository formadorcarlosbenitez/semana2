...
public class Runner
{
    ...
    public static void main(String[] args)
    {
        ...
        if (pin == 1234){
            cajeroMiBanco.saldoInicial = 1000000;
            System.out.print("Ingrese el monto a retirar: ");
            int monto = input.nextInt();
            //hacer uso del objeto tipo Cajero para realizar la operacion
            //de retirar
            cajeroMiBanco.monto = monto;
            cajeroMiBanco.imprimir();
            
            int saldoActual = cajeroMiBanco.calcularDescuento();
            
            System.out.println("El saldo disponible ahora es: " + saldoActual);
        } else {
